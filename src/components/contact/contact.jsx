...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "user_gmt9QUqWnbfY9XBw3XiMP";

    // YOUR EMAIL.JS TEMPLATE ID
    let TEMPLATE_ID = "template_ylj46lh";
          ...
          <Row className="padding40">
            <Col md={12} lg={6}>
              <form id="contact-form" onSubmit={this.handleSubmit}>
                <h4 className="font30 weight800 padding30">Stuur ons een bericht.</h4>
                <input type="text" placeholder="Naam" required name="name" value={this.state.name} onChange={this.inputHandler} />
